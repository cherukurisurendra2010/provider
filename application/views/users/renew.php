        ...
        <div id="body">
            <div style="width:20%;float: left;">Menu
              ...
              <!--<li class="ui-state-disabled"><div>Specials (n/a)</div></li>-->
				...
				<?php if($data['radius_user']){?>
                <?php echo $data['radius_user'][0]->username;?><br/>
                <?php echo $data['in_services'][0]->service;?><br/>
                <?php echo $data['in_services'][0]->subplan;?><br/>
                <?php echo $data['in_services'][0]->amount;?>
				<?php }?>
