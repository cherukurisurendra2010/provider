        ...
        <div id="body">
            <div style="width:20%;float: left;">Menu
              ...
              <!--<li class="ui-state-disabled"><div>Specials (n/a)</div></li>-->
				...
				<form name="form-renew" id="form-renew" method="post">
				<?php if($data['user']){?>
                <?php echo $data['user']['radius_user'][0]->username;?><br/>
                <?php echo $data['user']['in_services'][0]->service;?><br/>
                <?php echo $data['user']['in_services'][0]->subplan;?><br/>
                <?php echo $data['user']['in_services'][0]->amount;?><br/>
                <?php echo $data['invoice'][0]->service;?><br/>
                <?php echo $data['invoice'][0]->subplan;?><br/>
                <?php echo $data['invoice'][0]->invoice_id;?><br/>
                <?php echo $data['invoice'][0]->pending_amount;?><br/>
                <?php echo $data['invoice'][0]->paid_amount;?><br/>
                <?php echo $data['invoice'][0]->amount;?><br/>
                <?php echo $data['invoice'][0]->invoice_status;?><br/>
                <?php }?>
				<?php if($data['invoice'][0]->pending_amount!=0){?>
				<input type="text" name="pay_amount" id="pay_amount" value="<?php echo $data['invoice'][0]->pending_amount;?>" />
				<input type="checkbox" name="terms" id="terms" />Please Accept Terms and Conditions
				<select name="method" id="method"><option value="1">Cash</option></select>
