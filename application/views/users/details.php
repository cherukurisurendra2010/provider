...
<head>
	<meta charset="utf-8">
	<title>Welcome to Invic Radis System</title>
	...
	<div id="body">
            ...
            <table>
              ...
              <tr>
                ...
                <td><?php if($row->enableuser==1){echo "Active";?> | <a href="<?php echo base_url();?>user/renew/username/<?php echo $row->username;?>" id="<?php echo $row->email?>">Renew</a> | <a href="<?php echo base_url();?>user/invoices/username/<?php echo $row->username;?>" id="<?php echo $row->email?>">Invoices</a><?php }elseif ($row->enableuser==0) {
                    echo "Blocked";}?>
                </td>
              </tr>
              <?php
