        ...
        <div id="body">
            <div style="width:20%;float: left;">Menu
              ...
              <!--<li class="ui-state-disabled"><div>Specials (n/a)</div></li>-->
                ...
                <form name="manager_create_form" id="srv_create_form" method="post">
                    <table border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>Service Name:</td><td><input type="text" name="managername" id="managername"/></td>
                        </tr>
                        <tr>
                            <td>Description:</td><td><input type="text" name="comment" id="comment"/></td>
                        </tr>
                        <tr>
                            <td></td><td><input type="submit" name="addservice" value="Submit"/></td>
                        </tr>
                    </table>
                </form>
            </div>
