              ...
              <!--<li class="ui-state-disabled"><div>Specials (n/a)</div></li>-->
                ...
                <form name="e_create_form" id="e_create_form" method="post">
                    <table border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>Branch:</td><td><input type="text" name="branch" id="branch"/></td>
                        </tr>
                        <tr>
                            <td>Manager:</td><td>
                                  <select name="manager" id="manager">
                                    <?php foreach($managers as $manager){?>
                                    <option value="<?php echo $manager->id;?>"><?php echo $manager->managername;?></option>
                                    <?php } ?>
                                  </select>
                            </td>
                        </tr>
                        <tr>
                            <td></td><td><input type="submit" name="adduser" value="Add Branch"/></td>
                        </tr>
                    </table>
                </form>
            </div>
